...
local DefaultTheme = {
    ...
    Border = Color3.fromRGB(250, 250, 250),
...
function GUI:CreateMain(config)
    local settings = {
        Name = config.Name or "ProjectX",
        title = config.title or config.Title or "ProjectX",
        ...
        Config = {
            ...
            FolderName = config.Config and config.Config.FolderName or "ProjectX",
