...
function library:Main()
    ...
    PanelContainer.Size = UDim2.new(0, 400, 0, 300)
    PanelContainer.Active = true
    PanelContainer.Draggable = true
    ...
    ContentContainer.Size = UDim2.new(0, 340, 0, 450)
    ...
    ContentScrollContainer.Size = UDim2.new(0, 344, 0, 444)
    ...
    TabScrollContainer.Size = UDim2.new(0, 240, 0, 444)
